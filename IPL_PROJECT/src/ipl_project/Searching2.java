...
public class Searching2 extends javax.swing.JFrame {

    /**
     * Creates new form Searching2
     */
    public Searching2() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("TEAM RECORDS");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(240, 20, 320, 51);

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 0, 24)); // NOI18N
        jLabel2.setText("NAME OF THE TEAM");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(90, 130, 245, 34);
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        else
        {
            ...
            try
            {
                ...
                String sql1="Select * from O_cap1 where team like'%"+team+"%';";
                String sql2="Select * from O_cap2 where team like'%"+team+"%';";
                String sql3="Select * from O_cap3 where team like'%"+team+"%';";
                String sql4="Select * from O_cap4 where team like'%"+team+"%';";
                String sql5="Select * from O_cap5 where team like'%"+team+"%';";
                String sql6="Select * from O_cap6 where team like'%"+team+"%';";
                String sql7="Select * from P_cap1 where team like'%"+team+"%';";
                String sql8="Select * from P_cap2 where team like'%"+team+"%';";
                String sql9="Select * from P_cap3 where team like'%"+team+"%';";
                String sql10="Select * from P_cap4 where team like'%"+team+"%';";
                String sql11="Select * from P_cap5 where team like'%"+team+"%';";
                String sql12="Select * from P_cap6 where team like'%"+team+"%';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Searching2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Searching2().setVisible(true);
            }
        });
    }
