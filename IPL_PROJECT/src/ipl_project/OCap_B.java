 ...
 * @author hp
 */
public class OCap_B extends javax.swing.JFrame {

    /**
     * Creates new form OCap_B
     */
    public OCap_B() {
        initComponents();
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OCap_B.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
