...
public class PCap_B extends javax.swing.JFrame {

    /**
     * Creates new form PCap_B
     */
    public PCap_B() {
        initComponents();
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PCap_B.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
